...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Logo.setGeometry(QtCore.QRect(0, 0, 261, 71))
        self.Logo.setText(_fromUtf8(""))
        self.Logo.setPixmap(QtGui.QPixmap(_fromUtf8("../Data/online/PhoneSearchLogo.png")))
        ...
        self.phone10 = QtGui.QPushButton(Form)
        self.phone10.setGeometry(QtCore.QRect(330, 460, 111, 141))
        self.phone10.setText(_fromUtf8(""))
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8("../Data/online/images/10.jpg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.phone10.setIcon(icon11)
        self.phone10.setIconSize(QtCore.QSize(131, 131))
        self.phone10.setObjectName(_fromUtf8("phone10"))
        ...
        self.label.setPixmap(QtGui.QPixmap(_fromUtf8("../../PhoneArena/Data/UI_Icon/Logomakr_6YHD7m.png")))
        ...
        QtCore.QObject.connect(self.phone10, QtCore.SIGNAL(_fromUtf8("clicked()")), self.press10)
        QtCore.QObject.connect(self.phone10, QtCore.SIGNAL(_fromUtf8("clicked()")), Form.hide)
    ...
    def retranslateUi(self, Form):
        ...
        self.phone10.setToolTip(_translate("Form", "<html><head/><body><p>{}</p></body></html>".format(names[10]), None))
